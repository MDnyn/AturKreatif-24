...
def decrypt_file(input_file, output_file, password):
    print("Sorryy..Not to easy dear...this tool was modified by somebody..but he give this clue for u.. The image was encrypted using AES encryption with CBC mode and PKCS7 padding. A randomly generated IV (Initialization Vector) and salt were used for encryption. The encryption key was derived from the user-provided password using PBKDF2 with 1,000,000 iterations and a key length of 32 bytes.")
