...
<body>
  ...
  if (isset($_POST['id']) && filter_var($_POST['id'])) {
    ...
    $sql = "SELECT id, status, company, ticket, flight_from, flight_to FROM flight WHERE id = '$id'";
            ...
            <div class="card-body">
              ...
              <article class="card">
                <div class="card-body row">
                  <div class="col"> <strong>Flight From:</strong> <br><?php echo "$row[4]" ?></div>
                  <div class="col"> <strong>Flight To:</strong> <br> <?php echo "$row[5]" ?> </div>
